...
import { BookMarked, BriefcaseBusiness, MessageSquareText, Gem, Sparkles, Target, Crown, TrendingUp, BookOpen } from "lucide-react";
  ...
  return (
    <div className="flex flex-row flex-wrap py-8 px-4 gap-4">
      {DetailsCardList?.map((e, index) => {
        ...
        return (
          <Link href={"/"} className="flex flex-col border border-black p-4 rounded-xl" key={index}>
